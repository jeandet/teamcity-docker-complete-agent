...
docker run -d=true -e SERVER_URL=https://hephaistos.lpp.polytechnique.fr/teamcity --name=teamcity-docker-complete-agent -it jeandet/teamcity-docker-complete-agent0 &
sleep 300
